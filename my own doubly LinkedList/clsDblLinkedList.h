...
public:
    ...
    T GetItem(const int &index)
    {
        ...
        {
            return T(); // Default value for type T (e.g., int() will return 0, string() will return "")

            // You should return a default value that makes sense for your data type T
            // For example, if T is an integer type, you can return 0 or -1.
            // Adjust this default value based on the actual data type of T.

            // or use the below function but in your main function you should handle the case if the return value is null
        }
    }
    ...
    */
    ...
    bool UpdateItems(const int &index, T newValue)
    {
